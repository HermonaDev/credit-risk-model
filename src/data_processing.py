...
def create_customer_features(df, snapshot_date=None):
    ...
    customer_features = customer_features.merge(
        last_transaction[['CustomerId', 'recency']], on='CustomerId'
    )
...
def prepare_training_data(raw_data_path):
    ...
    # Create transaction-level time features (not used in customer features)
    _ = create_transaction_features(df)  # Unused but kept for completeness
